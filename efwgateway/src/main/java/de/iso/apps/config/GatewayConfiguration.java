...
@Configuration public class GatewayConfiguration {
    ...
    @Configuration public static class AccessControlFilterConfiguration {
     ...
     * <p>
     * This uses Bucket4J to limit the API calls, see {@link de.iso.apps.gateway.ratelimiting.RateLimitingFilter}.
     */
    @Configuration @ConditionalOnProperty("jhipster.gateway.rate-limiting.enabled")
