package de.iso.apps.gateway.ratelimiting;
...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(JHipsterProperties jHipsterProperties) {
        ...
        CompleteConfiguration<String, GridBucketState> config = new MutableConfiguration<String, GridBucketState>().setTypes(
            String.class,
            GridBucketState.class);
