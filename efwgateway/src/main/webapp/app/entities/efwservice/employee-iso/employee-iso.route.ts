...
export class EmployeeIsoResolve implements Resolve<IEmployeeIso> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<IEmployeeIso> {
        ...
        if (id) {
            return this.service.find(id).pipe(filter((response: HttpResponse<EmployeeIso>) => response.ok),
...
export const employeeRoute: Routes = [{
    path: '', component: EmployeeIsoComponent, data: {
        authorities: ['ROLE_TPL', 'ROLE_ADMIN'], pageTitle: 'efwgatewayApp.efwserviceEmployee.home.title'
    }, canActivate: [UserRouteAccessService]
}, {
    path: ':id/view', component: EmployeeIsoDetailComponent, resolve: {
        employee: EmployeeIsoResolve
    }, data: {
        authorities: ['ROLE_TPL', 'ROLE_ADMIN'], pageTitle: 'efwgatewayApp.efwserviceEmployee.home.title'
    }, canActivate: [UserRouteAccessService]
}, {
    path: 'new', component: EmployeeIsoUpdateComponent, resolve: {
        employee: EmployeeIsoResolve
    }, data: {
        authorities: ['ROLE_ADMIN'], pageTitle: 'efwgatewayApp.efwserviceEmployee.home.title'
    }, canActivate: [UserRouteAccessService]
}, {
    path: ':id/edit', component: EmployeeIsoUpdateComponent, resolve: {
        employee: EmployeeIsoResolve
    }, data: {
        authorities: ['ROLE_TPL', 'ROLE_ADMIN'], pageTitle: 'efwgatewayApp.efwserviceEmployee.home.title'
    }, canActivate: [UserRouteAccessService]
...
export const employeePopupRoute: Routes = [{
    path: ':id/delete', component: EmployeeIsoDeletePopupComponent, resolve: {
        employee: EmployeeIsoResolve
    }, data: {
        authorities: ['ROLE_ADMIN'], pageTitle: 'efwgatewayApp.efwserviceEmployee.home.title'
