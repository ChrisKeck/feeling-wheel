...
@Component({
               selector: 'jhi-feeling-iso-delete-dialog', templateUrl: './feeling-iso-delete-dialog.component.html'
           })
    ...
    confirmDelete(id: number) {
        this.feelingService.delete(id).subscribe(response => {
            this.eventManager.broadcast({
                                            name: 'feelingListModification', content: 'Deleted an feeling'
                                        });
...
@Component({
               selector: 'jhi-feeling-iso-delete-popup', template: ''
           })
export class FeelingIsoDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({feeling}) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(FeelingIsoDeleteDialogComponent as Component, {
