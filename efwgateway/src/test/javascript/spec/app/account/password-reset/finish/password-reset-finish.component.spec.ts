    ...
    describe('PasswordResetFinishComponent', () => {
        ...
        beforeEach(() => {
            fixture = TestBed.configureTestingModule({
                                                         imports: [EfwgatewayTestModule], declarations: [PasswordResetFinishComponent], providers: [{
        ...
        it('should update success to OK after resetting password',
           inject([PasswordResetFinishService], fakeAsync((service: PasswordResetFinishService) => {
