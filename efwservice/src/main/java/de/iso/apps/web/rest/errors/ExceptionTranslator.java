 ...
 */
@ControllerAdvice public class ExceptionTranslator implements ProblemHandling {
    ...
    public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity, NativeWebRequest request) {
        ...
        if (problem instanceof ConstraintViolationProblem) {
            ...
            builder.withCause(((DefaultProblem) problem).getCause()).withDetail(problem.getDetail()).withInstance(
                problem.getInstance());
    ...
    public ResponseEntity<Problem> handleNoSuchElementException(NoSuchElementException ex, NativeWebRequest request) {
        Problem problem = Problem.builder()
                                 ...
                                 .with(MESSAGE_KEY,
                                       ErrorConstants.ENTITY_NOT_FOUND_TYPE)
                                 .build();
        return create(ex, problem, request);
    }
