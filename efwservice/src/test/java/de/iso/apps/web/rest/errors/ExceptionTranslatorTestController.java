...
@RestController public class ExceptionTranslatorTestController {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "test response status") public static class TestResponseStatusException extends RuntimeException {
    }
