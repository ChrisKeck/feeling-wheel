...
```
$ docker image tag efwgateway standard/efwgateway
$ docker push standard/efwgateway
$ docker image tag efwservice standard/efwservice
$ docker push standard/efwservice
```
