...
@Configuration @EnableJpaRepositories("de.iso.apps.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware") @EnableTransactionManagement
@EnableElasticsearchRepositories("de.iso.apps.repository.search") public class DatabaseConfiguration {
